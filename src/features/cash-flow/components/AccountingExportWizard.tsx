...
import { XMarkIcon, Cog6ToothIcon, ArrowDownTrayIcon, CheckCircleIcon, ExclamationTriangleIcon } from '../../../components/ui/Icons';
...
export const AccountingExportWizard: React.FC<AccountingExportWizardProps> = ({ isOpen, onClose, selectedArqueos = [] }) => {
    ...
    const headerTitle = (
        <span className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">Exportar Contabilidad</span>
        </span>
    );
