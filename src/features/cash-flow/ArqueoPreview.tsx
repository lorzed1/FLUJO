    ...
    return (
        <div className={cn("animate-fadeIn", form.isDarkMode ? 'dark' : '')}>
            ...
            <div className="mt-4 sm:mt-6">
                ...
                {activeTab === 'arqueo' && (
                    <div className="max-w-xl mx-auto w-full pb-20 animate-fadeIn">
                        <form onSubmit={form.handleSubmit} className="space-y-6">
                            ...
                            <Card className="p-6 rounded-3xl shadow-lg border-0 dark:bg-slate-800">
                                ...
                                <div className="space-y-5">
                                    <div>
                                        <label className="block text-sm font-bold text-gray-400 mb-2 uppercase">Fecha</label>
                                        <input type="date" value={form.formData.fecha} readOnly className="w-full h-14 px-4 rounded-xl bg-gray-50 dark:bg-slate-700 border border-gray-100 focus:outline-none" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-gray-400 mb-2 uppercase">Cajero</label>
                                        <input type="text" name="cajero" value={form.formData.cajero} onChange={form.handleSimpleChange} className="w-full h-14 px-4 rounded-xl border border-gray-200 dark:border-slate-700 dark:bg-slate-700 focus:ring-2 focus:ring-purple-500 outline-none" required />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-gray-400 mb-2 uppercase">Visitas</label>
                                        <input type="number" name="visitas" value={form.formData.visitas || ''} onChange={form.handleSimpleChange} className="w-full h-14 px-4 rounded-xl border border-gray-200 dark:border-slate-700 dark:bg-slate-700 focus:ring-2 focus:ring-purple-500 outline-none" placeholder="0" />
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6 rounded-3xl shadow-lg border-0 dark:bg-slate-800">
                                ...
                                <div className="space-y-4">
                                    <CurrencyInput label="Covers" name="ingresoCovers" value={form.formData.ingresoCovers} onChange={form.handleCurrencyChange} useMonoFont={useMonoFont} />
                                    <CurrencyInput label="Venta POS" name="ventaBruta" value={form.formData.ventaBruta} onChange={form.handleCurrencyChange} useMonoFont={useMonoFont} />
                            ...
                            <Card className="p-6 rounded-3xl shadow-lg border-0 dark:bg-slate-800 relative overflow-hidden">
                                ...
                                <div className="space-y-4">
                                    <CurrencyInput label="Efectivo" name="efectivo" value={form.formData.efectivo} readOnly onChange={() => { }} onDetailClick={() => form.setIsCalculatorExpanded(true)} useMonoFont={useMonoFont} sublabel="Sincronizado con calculadora" />
                                    <CurrencyInput label="Datafo David" name="datafonoDavid" value={form.formData.datafonoDavid} onChange={form.handleCurrencyChange} useMonoFont={useMonoFont} />
                                    <CurrencyInput label="Datafo Julián" name="datafonoJulian" value={form.formData.datafonoJulian} onChange={form.handleCurrencyChange} useMonoFont={useMonoFont} />
                                    <div className="grid grid-cols-1 gap-4 pt-4 border-t border-dashed border-gray-200 dark:border-slate-700">
                                        <CurrencyInput label="Bancolombia" name="transfBancolombia" value={form.formData.transfBancolombia} readOnly onChange={() => { }} onDetailClick={() => form.openDetailModal('transfBancolombia', 'Bancolombia')} useMonoFont={useMonoFont} />
                                        <CurrencyInput label="Nequi" name="nequi" value={form.formData.nequi} readOnly onChange={() => { }} onDetailClick={() => form.openDetailModal('nequi', 'Nequi')} useMonoFont={useMonoFont} />
                            ...
                            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-t z-50 flex justify-center">
                                <div className="max-w-xl w-full">
                                    <button type="submit" className="w-full py-4 bg-gray-900 dark:bg-blue-600 text-white text-lg font-bold rounded-2xl shadow-xl active:scale-95 transition-transform flex items-center justify-center gap-3">
