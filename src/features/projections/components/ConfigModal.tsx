    ...
    return (
        ...
        >
            <div className="flex flex-col flex-1 min-h-0">
                ...
                <div className="px-5 py-2 border-b border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800 shrink-0">
                ...
                {/* Content */}
                <div className="p-5 overflow-y-auto custom-scrollbar space-y-4 max-h-[60vh] flex-1">
                    {/* TAB 1: ALGORITMO */}
                    {activeTab === 'algorithm' && (
                        <div className="space-y-4">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="text-sm font-bold text-gray-800 dark:text-white">{localConfig.lookbackWeeks} <span className="text-xs2 font-medium text-gray-400 uppercase">semanas</span></span>
                                </div>
                                <p className="text-xs text-gray-400 mb-2">Semanas históricas para detectar tendencias.</p>
                                <input
                            ...
                            <div className="border-t border-gray-100 dark:border-slate-700 pt-4">
                                ...
                                <p className="text-xs text-gray-400 mb-2">Días excluidos por ser atípicamente bajos.</p>
                                <input
                            ...
                            {/* Weight Mode */}
                            <div className="border-t border-gray-100 dark:border-slate-700 pt-4">
                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3 flex items-center gap-1.5">
                                ...
                                <div className="grid grid-cols-3 gap-2 mt-2">
                                    {[
                                        ...
                                        <button
                                            ...
                                            `}
                                        >
                                            <p className={`text-xs font-bold ${localConfig.recencyWeightMode === mode.id ? 'text-purple-600' : 'text-gray-700 dark:text-gray-300'}`}>{mode.label}</p>
                                            <p className="text-xs2 text-gray-400 mt-0.5 leading-tight">{mode.desc}</p>
                                        </button>
                                    ))}
                                </div>
                            </div>
                    ...
                    {activeTab === 'strategy' && (
                        <div className="space-y-4">
                            {/* Inflación (IPC) */}
                            <div>
                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-widest flex items-center gap-1.5 mb-1.5">
                                    <BanknotesIcon className="w-3.5 h-3.5" />
                                    Ajuste por Inflación (IPC)
                                </label>
                                <p className="text-xs text-gray-400 mb-2">Normalizar precios históricos.</p>
                                <div className="relative">
                                    <input
                                        type="number" step="0.1"
                                        className="w-full h-9 px-3 pr-8 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded text-sm- font-medium text-gray-700 dark:text-white focus:ring-1 focus:ring-purple-600 focus:border-purple-600"
                                ...
                                <p className="text-xs2 text-gray-400 mt-2 italic leading-relaxed">
                            ...
                            <div className="border-t border-gray-100 dark:border-slate-700 pt-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs2 text-gray-400 leading-tight">Meta para atraer más clientes.</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs2 text-gray-400 leading-tight">Meta para aumentar el consumo.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {activeTab === 'events' && (
                        <div className="space-y-3">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mb-3">Importación masiva de estacionalidad oficial.</p>
                            </div>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-sm- font-medium text-gray-700 dark:text-gray-200">Festivos Colombia {new Date().getFullYear()}</p>
                                    <p className="text-xs text-gray-400">Ponderación automática para feriados oficiales.</p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-sm- font-medium text-gray-700 dark:text-gray-200">Ciclo de Quincenas</p>
                                    <p className="text-xs text-gray-400">Marca los días 15 y 30 con boost (+15%).</p>
                                </div>
                            </button>
                ...
                {/* Footer */}
                <div className="bg-gray-50 dark:bg-slate-800/50 px-5 py-3 border-t border-gray-100 dark:border-slate-700 flex justify-end gap-2 mt-auto shrink-0">
                    <Button
                        variant="secondary"
