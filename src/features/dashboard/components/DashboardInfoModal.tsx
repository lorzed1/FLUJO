...
import { LightBulbIcon, ChartBarIcon, CalculatorIcon, ShoppingCartIcon, CurrencyDollarIcon, BanknotesIcon, PresentationChartLineIcon } from '../../../components/ui/Icons';
            ...
            <div className="p-5 space-y-6 max-h-[65vh] overflow-y-auto custom-scrollbar">
                ...
                <section>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="text-xs font-bold text-gray-800 dark:text-gray-100 uppercase tracking-widest">Módulo de Compras</h4>
                    </div>
                    <div className="space-y-3">
                        <div className="p-3 rounded border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/30">
                            <p className="font-semibold text-sm- text-gray-700 dark:text-gray-200 mb-1 flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-purple-500"></span>
                                Total Compras (Mensual)
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 ml-3.5 leading-tight">
                        ...
                        <div className="p-3 rounded border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/30">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 ml-3.5 leading-tight mb-2">
                            ...
                            <div className="bg-white dark:bg-slate-800 px-3 py-2 border border-slate-200 dark:border-slate-600 rounded">
                                <p className="font-mono text-xs text-indigo-600 dark:text-indigo-400 font-semibold text-center">
                        ...
                        <div className="p-3 rounded border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/30">
                            ...
                            <div className="bg-white dark:bg-slate-800 px-3 py-2 border border-slate-200 dark:border-slate-600 rounded">
                                <p className="font-mono text-xs text-emerald-600 dark:text-emerald-400 font-semibold text-center mb-1">
                                    Límite Presupuesto = Ventas Netas(Semana Anterior) × 0.40
                                </p>
                                <p className="font-mono text-xs text-emerald-600 dark:text-emerald-400 font-semibold text-center">
                ...
                <section>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="text-xs font-bold text-gray-800 dark:text-gray-100 uppercase tracking-widest">Módulo de Ventas</h4>
                    </div>
                    <div className="space-y-3">
                        <div className="p-3 rounded border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/30">
                            <p className="font-semibold text-sm- text-gray-700 dark:text-gray-200 mb-1 flex items-center gap-2">
                            ...
                            <ul className="text-xs text-gray-500 dark:text-gray-400 ml-3.5 leading-tight list-disc pl-4 space-y-1">
                ...
                <section>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="text-xs font-bold text-gray-800 dark:text-gray-100 uppercase tracking-widest">General, Egresos y Reglas</h4>
                    </div>
                    <div className="space-y-3">
                        <div className="p-3 rounded border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/30">
                            <p className="font-semibold text-sm- text-gray-700 dark:text-gray-200 mb-1 flex items-center gap-2">
